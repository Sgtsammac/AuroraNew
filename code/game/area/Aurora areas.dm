...
NOTE: there are two lists of areas in the end of this file: centcom and station itself. Please maintain these lists valid. --rastaf0
 Don't rename any area without checking it, there are some areas used in the code in random places
*/
...
//Should have different areas for turrets on another zLevel
//but this is how the turrets work  at the moment
...
area/spacelift/planet
	name = "\improper Spacelift"

area/spacelift/space
	name = "\improper Spacelift"
...
/area/space
	...
	power_equip = 0
	power_environ = 0
	has_gravity = 0 //Bypassed as space is identified by name rather than area
...
/*-----------------------------
--- Locations at base on planet
-----------------------------*/



/*-----------------------------
--- Locations at base off planet
-----------------------------*/
...
// because it's already organised (kinda)
...
/*-----------------------------
--- Bay Code stuff - to remove or sort
-----------------------------*/
...
/area/station/construction/supplyshuttle
	name = "\improper Supply Shuttle"
	icon_state = "yellow"

/area/station/construction/quarters
	name = "\improper Engineer's Quarters"
	icon_state = "yellow"

/area/station/construction/qmaint
	name = "Maintenance"
	icon_state = "yellow"

/area/station/construction/hallway
	name = "\improper Hallway"
	icon_state = "yellow"

/area/station/construction/solars
	name = "\improper Solar Panels"
	icon_state = "yellow"

/area/station/construction/solarscontrol
	name = "\improper Solar Panel Control"
	icon_state = "yellow"

/area/station/construction/Storage
...
//We won't need these lists if we get this file sorted
/////////////////////////////////////////////////////////////////////
/*
...
var/list/the_station_areas = list (
	...
	/area/shuttle/mining/station,
	/area/shuttle/transport1/station,
	// /area/station/shuttle/transport2/station,
	/area/shuttle/prison/station,
	/area/shuttle/administration/station,
	/area/shuttle/specops/station,
	/area/station/atmos,
