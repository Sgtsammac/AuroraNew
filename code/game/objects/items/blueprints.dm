...
"}
		if (AREA_PLANET)
			text += {"
<p>According the blueprints, you are now on <b>The Planet</b>.  Get inside.</p>
<p><a href='?src=\ref[src];action=create_area'>Mark this place as new area.</a></p>
"}
		if (AREA_SPECIAL)
			text += {"
...
//Lets move this to a list in Aurora areas ?? - SoundScopes
/obj/item/blueprints/proc/get_area_type(var/area/A = get_area())
	if (istype(A, /area/space))
		return AREA_SPACE
	if(istype(A, /area/planet))
		return AREA_PLANET
