//ground movement for the maglev trains

/turf/planet/transit
	var/pushdirection // push things that get caught in the transit tile this direction

//Overwrite because we dont want people building rods in space.
/turf/planet/transit/attackby(obj/O as obj, mob/user as mob)
	return

/turf/planet/transit/north // moving to the north

	pushdirection = SOUTH  // south because the space tile is scrolling south

	//IF ANYONE KNOWS A MORE EFFICIENT WAY OF MANAGING THESE SPRITES, BE MY GUEST. -No idea who said that but I can try
	//Also we need sprites for movement system for maglev trains
	shuttlespace_ns1
