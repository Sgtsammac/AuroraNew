	...
	if((N == /turf/space) || (N == /turf/planet))
		...
		for(var/obj/effect/landmark/zcontroller/c in controller)
			if(c.down)
				...
				if((air_master.has_valid_zone(below) || air_master.has_valid_zone(src)) && (!istype(below, /turf/space) || !istype(below, /turf/planet))) // dont make open space into space, its pointless and makes people drop out of the station
