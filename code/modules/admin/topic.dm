...
/*				if("shockwave")
			...
			if("eagles")//SCRAW
				...
				for(var/obj/machinery/door/airlock/W in world)
					if(W.z == 1 && !istype(get_area(W), /area/station/bridge) && !istype(get_area(W), /area/crew_quarters) && !istype(get_area(W), /area/station/security/prison))
						W.req_access = list()
